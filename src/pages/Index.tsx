        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-primary-foreground mb-6 tracking-tight drop-shadow-2xl">
              Secure. Scale. <span className="text-accent drop-shadow-glow">Synk.</span>
            </h1>
            ...
            <p className="text-lg text-primary-foreground/80 mb-12 max-w-2xl mx-auto">
              Empowering governments, businesses, and visionary founders with secure, intelligent, 
              and scalable digital systems built for Africa's digital future.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" className="btn-gold text-lg px-8 py-4 font-semibold">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="text-lg px-8 py-4 border-accent/50 text-primary bg-accent/20 hover:border-accent backdrop-blur-sm transition-all duration-300 hover:shadow-gold hover:bg-accent/20 hover:border-accent backdrop-blur-sm transition-all duration-300 hover:shadow-gold"
                onClick={() => {
                  // Create a downloadable PDF or open in new tab
                  const link = document.createElement('a');
                  link.href = '#'; // Replace with actual company profile URL/file
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              {services.slice(0, 3).map((service, index) => (
                <Card key={index} className="gradient-card border-0 shadow-luxury hover:shadow-glow transition-all duration-500 group hover:-translate-y-2">
                  <CardContent className="p-8 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <Button variant="outline" size="sm" className="group-hover:gradient-luxury group-hover:text-accent-foreground group-hover:border-accent/30 transition-all duration-300">
                        Learn More
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {services.slice(3).map((service, index) => (
                <Card key={index + 3} className="gradient-card border-0 shadow-luxury hover:shadow-glow transition-all duration-500 group hover:-translate-y-2">
                  <CardContent className="p-8 text-center relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-accent/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <div className="relative z-10">
                      <div className="w-16 h-16 gradient-luxury rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-glow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  We combine international best practices with deep African market understanding 
                  to deliver technology solutions that truly work for your business.
                </p>
                ...
                <CardContent className="p-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                      ...
                      with secure, intelligent, and scalable digital systems — built to elevate 
                      Africa's digital future.
                    </p>
                    <p className="text-muted-foreground">
                      We bridge the gap between cutting-edge global technology and practical 
            ...
            <Card className="gradient-hero text-primary-foreground shadow-luxury border-0 relative overflow-hidden">
              ...
              <CardContent className="p-12 text-center relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link to="/contact">
                    <Button size="lg" className="gradient-luxury text-accent-foreground shadow-glow hover:scale-105 transition-all duration-300">
                      <Calendar className="mr-2" size={20} />
                      Get Started Today
                    </Button>
                  </Link>
