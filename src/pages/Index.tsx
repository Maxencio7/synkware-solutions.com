...
const testimonials = [
  {
    ...
    content: "SYNKWARE transformed our on prem and cloud operations. We've seen a reduction in workload and increase accuracy in deliveries.",
    rating: 5
  },
  {
    name: "Michael Chen",
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
            ...
            <p className="text-lg text-primary-foreground/80 mb-12 max-w-2xl mx-auto">
              Join 10+ companies worldwide who trust SYNKWARE to drive their digital transformation and achieve measurable results.
            </p>
              ...
              {stats.map((stat, index) => (
                ...
                >
                  <CardContent className="p-6">
                    ...
                    <div className="text-4xl md:text-5xl font-bold text-primary mb-2 transition-all duration-300 group-hover:scale-110">{stat.number}</div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative">
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 md:gap-12">
                {[
                  { id: 'microsoft', logo: partnerMicrosoft, name: "Microsoft", shape: "65% 35% 70% 30% / 50% 60% 40% 50%" },
                  { id: 'sap', logo: partnerSAP, name: "SAP", shape: "40% 60% 55% 45% / 60% 50% 50% 40%" },
                  { id: 'dell', logo: partnerDell, name: "Dell", shape: "55% 45% 45% 55% / 65% 35% 65% 35%" },
                  { id: 'hp', logo: partnerHP, name: "HP", shape: "50% 50% 70% 30% / 45% 55% 45% 55%" },
                  { id: 'aws', logo: partnerAWS, name: "AWS", shape: "45% 55% 50% 50% / 55% 45% 60% 40%" },
                  { id: '4sight', logo: partner4sight, name: "4sight", shape: "60% 40% 60% 40% / 50% 50% 50% 50%" },
                  { id: 'huawei', logo: partnerHuawei, name: "Huawei", shape: "35% 65% 55% 45% / 70% 30% 60% 40%" },
                  { id: 'google', logo: partnerGoogle, name: "Google", shape: "70% 30% 50% 50% / 40% 60% 50% 50%" },
                  { id: 'abb', logo: partnerABB, name: "ABB", shape: "50% 50% 60% 40% / 65% 35% 55% 45%" },
                  { id: 'logpoint', logo: partnerLogpoint, name: "Logpoint", shape: "40% 60% 45% 55% / 55% 45% 70% 30%" }
                ].map((partner, index) => (
                  <Link
                    key={index}
            ...
            <div className="mt-16 text-center">
              ...
              <Link to="/contact">
                <Button variant="outline" size="lg" className="border-accent/30 bg-accent/30 hover:bg-accent/10 hover:border-accent transition-all duration-300">
                  Get In Touch
              ...
              {features.map((feature, index) => (
                ...
                >
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-semibold text-primary mb-2 transition-colors duration-300 group-hover:text-accent">{feature.title}</h3>
            ...
            <Card className="gradient-hero text-primary-foreground shadow-luxury border-0 relative overflow-hidden">
              ...
              <CardContent className="p-12 text-center relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link to="/services">
                    <Button size="lg" variant="outline" className="text-lg px-8 py-4 border-primary-foreground/30 text-primary-foreground bg-primary-foreground/30 hover:bg-primary-foreground/10 hover:border-primary-foreground backdrop-blur-sm transition-all duration-300">
