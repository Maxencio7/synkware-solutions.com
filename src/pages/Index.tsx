          ...
          <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 py-4 border-accent/50 text-primary bg-accent/50 hover:border-accent backdrop-blur-sm transition-all duration-300 hover:shadow-gold hover:bg-accent/20 hover:border-accent backdrop-blur-sm transition-all duration-300 hover:shadow-gold"
                onClick={() => {
